if __name__ == "__main__":
    ...
    dir24OS=fout.mkdir("mt_vbf_D0_0p8to1p0")
    ...
    dir34OS=fout.mkdir("mt_vbf_D0_0p8to1p0_DCPm")
    ...
    dir44OS=fout.mkdir("mt_vbf_D0_0p8to1p0_DCPp")
    ...
    dir54OS=fout.mkdir("mt_vbf_D0hplus_0p8to1p0")
    ...
    dir64OS=fout.mkdir("mt_vbf_DL1_0p8to1p0")
    ...
    dir74OS=fout.mkdir("mt_vbf_DL1Zg_0p8to1p0")
  ...
  #  plots=[ "h1D_jpt1", "h1D_jpt2", "h1D_mjj", "h1D_met"]
    ...
    #for k in range(0,nbhist):
        ...
        SFpassOS2=SFpassOS1
        hW0jet=fW.Get("OS_control/"+str(plots[k])+"_OS_W")
        hW0jet.Scale(SFpassOS2*factorw2jet)
        hW0jet_SS=fW.Get("SScontrol/"+str(plots[k])+"_SS_W")
        hW0jet_SS.Scale(SFpassOS2*factorw2jet)
        hW0jet_QCD=fW.Get("QCDcontrol/"+str(plots[k])+"_QCD_W")
        hW0jet_QCD.Scale(SFpassOS2*factorw2jet)

        fout.cd()

        dir0OS.cd()
        hW0jet.SetName(str(plots[k])+"_OS_W")
        hW0jet.Write()

        dir0SS.cd()
        hW0jet_SS.SetName(str(plots[k])+"_SS_W")
        hW0jet_SS.Write()

        dir0QCD.cd()
        hW0jet_QCD.SetName(str(plots[k])+"_QCD_W")
        hW0jet_QCD.Write()
