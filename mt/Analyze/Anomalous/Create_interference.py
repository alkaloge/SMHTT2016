if __name__ == "__main__":
    ...
    fout.cd()
    dir0=fout.mkdir("mt_0jet")
    dir1=fout.mkdir("mt_boosted")
    dir20=fout.mkdir("mt_vbf_D0_0p0to0p2")
    dir21=fout.mkdir("mt_vbf_D0_0p2to0p4")
    dir22=fout.mkdir("mt_vbf_D0_0p4to0p6")
    dir23=fout.mkdir("mt_vbf_D0_0p6to0p8")
    dir24=fout.mkdir("mt_vbf_D0_0p8to1p0")
    ...
    for k in range(0,nbhist):
        hM_0=fM.Get("mt_0jet/qqH_htt_0M125"+postfix0[k])
        hPM_0=fPM.Get("mt_0jet/qqH_htt125"+postfix0[k])
        ...
        hM_1=fM.Get("mt_boosted/qqH_htt_0M125"+postfix1[k])
        hPM_1=fPM.Get("mt_boosted/qqH_htt125"+postfix1[k])
	...
	hM_20=fM.Get("mt_vbf_D0_0p0to0p2/qqH_htt_0M125"+postfix2[k])
        hPM_20=fPM.Get("mt_vbf_D0_0p0to0p2/qqH_htt125"+postfix2[k])
	...
	for i in range(0,hPositive_20.GetSize()-2):
        ...
        hM_21=fM.Get("mt_vbf_D0_0p2to0p4/qqH_htt_0M125"+postfix2[k])
        hPM_21=fPM.Get("mt_vbf_D0_0p2to0p4/qqH_htt125"+postfix2[k])
        ...
        hM_22=fM.Get("mt_vbf_D0_0p4to0p6/qqH_htt_0M125"+postfix2[k])
        hPM_22=fPM.Get("mt_vbf_D0_0p4to0p6/qqH_htt125"+postfix2[k])
        ...
        hM_23=fM.Get("mt_vbf_D0_0p6to0p8/qqH_htt_0M125"+postfix2[k])
        hPM_23=fPM.Get("mt_vbf_D0_0p6to0p8/qqH_htt125"+postfix2[k])
        ...
        hM_24=fM.Get("mt_vbf_D0_0p8to1p0/qqH_htt_0M125"+postfix2[k])
        hPM_24=fPM.Get("mt_vbf_D0_0p8to1p0/qqH_htt125"+postfix2[k])
